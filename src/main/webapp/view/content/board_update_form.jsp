...
<div class="page_wrap">
	...
	<div class="board_title">
		<input type="text" name="title" class="title_box" value="${boardDetail.title }" placeholder="제목을 입력해 주세요." maxlength="30">
	</div>
	<div class="board_content">
		<textarea name="content" class="textarea_box">${boardDetail.content }</textarea>
	</div>
	<div class="btn_wrap">
		<div>
